...
import org.metadatacenter.terminology.bioportal.domainObjects.SearchResult;
...
public class SearchResultsDeserializer extends JsonDeserializer<SearchResults>
{
  @Override
  public SearchResults deserialize(JsonParser parser, DeserializationContext ctx) throws IOException
  {
    ...
    return new SearchResults(page, pageCount, pageSize, prevPage, nextPage, collection);
  }
}