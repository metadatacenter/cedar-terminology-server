...
import org.metadatacenter.terminology.bioportal.dao.RelationDAO;
...
import org.metadatacenter.terminology.util.ObjectConverter;
...
import static org.metadatacenter.terminology.util.Constants.BP_SEARCH_BASE_URL;
import static org.metadatacenter.terminology.util.Constants.BP_SEARCH_SCOPE_ALL;
import static org.metadatacenter.terminology.util.Constants.BP_SEARCH_SCOPE_CLASSES;
import static org.metadatacenter.terminology.util.Constants.BP_SEARCH_SCOPE_VALUES;
import static org.metadatacenter.terminology.util.Constants.BP_SEARCH_SCOPE_VALUE_SETS;
import static org.metadatacenter.terminology.util.Constants.BP_VS_COLLECTIONS;
import static org.metadatacenter.terminology.util.Constants.BP_VS_CREATION_COLLECTIONS;
...
//
//  // TODO: extend it to work with regular classes
//  public ValueSet findValueSet(String id, String apiKey) throws IOException
//  {
//    return valueSetDAO.find(id, apiKey);
//  }
//
